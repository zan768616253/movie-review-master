...
def build_paths(config: dict) -> Paths:
    ...
    return Paths(
        ...
        stage5_review_video=stage5_dir / "review.mp4",
        final_video=stage6_dir / "final_video.mp4",
        final_video_manifest=stage6_dir / "delivery_manifest.json",
    )
