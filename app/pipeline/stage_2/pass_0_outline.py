...
def build_outline_prompt(
    *,
    ...
    sections.append(
        ...
        "Each entry:\n"
        "- `id`: two-digit zero-padded sequential — `scene:01`, `scene:02`, ..., `scene:25`. "
        "Use the same format consistently throughout the document, including in "
        "`character_glossary[].first_seen_scene`.\n"
        ...
        "- The act_tag distribution should roughly match the niu-shu act-balance: the single HOOK "
        "scene spans ~3-5% of runtime; SETUP 15-20%; ESCALATION 25-30%; CLIMAX 35-40%; "
        "RESOLUTION 10-15%; CLOSING 2-4%.\n"
